...
import { migrateNarrative } from "@/lib/modules/narrative/migrate";
...
const MODULE_MIGRATORS: Array<(client: PoolClient) => Promise<void>> = [migrateBehavior, migrateCompliance, migrateCampaigns, migrateStudio, migrateNarrative];
