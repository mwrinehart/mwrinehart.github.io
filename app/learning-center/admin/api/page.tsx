    ...
    return (
      <>
        ...
        <LcEmpty title="Managed at the tenant level">
          API keys are configured for the <span className="font-semibold">{rootTeam?.Name ?? rootId}</span> tenant. You administer a sub-team — ask a tenant admin to change them.
        </LcEmpty>
      </>
    );
  }
